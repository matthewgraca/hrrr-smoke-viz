...
from tensorflow.keras.layers import (
    ...
    Reshape, UpSampling2D, concatenate, Concatenate,
    Add, Multiply, GlobalAveragePooling2D 
)
...
class DualAutoencoder:
    ...
    def conv3d_bn(self):
        ...
        def arm_block(
            ...
            x_out = Add(name=f'skip_{prefix}_lstm1')([x_1, x_in])
            ...
            y_out = Add(name=f'skip_{prefix}_res1_proj')([y_1, y_in])
