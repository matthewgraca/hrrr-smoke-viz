...
class PM25TrainingPipeline:
    ...
    def load_data(self):
        ...
        ### AR: config'd to support 
        ### Train and valid need to change, but we keep test because the
        ###     autoregression is happening on the inference level only 
        data = {
    ...
    def _build_two_path(self, input_shape):
        # AR: edited to support autoregression. just return_sequences false.
        # changed a few filters here to maintain the structure best I can
        ...
        combined = ConvLSTM2D(20, (3,3), padding='same', return_sequences=False)(combined)
        combined = Conv2D(10, (3,3), activation='relu', padding='same')(combined)
